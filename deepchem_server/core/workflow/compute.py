...
from deepchem_server.core.primitives import docking, evaluator, feat, inference, splitter, train
from deepchem_server.core.primitives.fep import collate_rbfe_results, run_rbfe


program_map = {
    "featurize": feat.featurize,
    "train": train.train,
    "evaluate": evaluator.model_evaluator,
    "infer": inference.infer,
    "train_valid_test_split": splitter.train_valid_test_split,
    "generate_pose": docking.docking_generate_pose,
    "relative_binding_free_energy": run_rbfe.run_rbfe,
    "collate_rbfe_results": collate_rbfe_results.collate_rbfe_results,
}
