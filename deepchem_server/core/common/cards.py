    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert (file_type
                in self.SUPPORTED_FILE_TYPES), "Filetype {} is not supported. Supported data type are {}".format(
    ...
    def validate_datatype(self, data_type: str) -> str:
        ...
        assert (data_type
                in self.SUPPORTED_DATA_TYPES), "Datatype {} is not supported. Supported file type are {}".format(
...
class ModelCard(Card):
    ...
    **kwargs
    ...
    def get_supported_model_types():
        """Get supported model types from model_mappings."""
        from deepchem_server.core.common.model_mappings import model_address_map

        return list(model_address_map.keys())
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert (model_type
                in supported_model_types), "Model type {} is not supported. Supported model types are {}".format(
                    model_type, " ".join(supported_model_types))
        self.address = address
