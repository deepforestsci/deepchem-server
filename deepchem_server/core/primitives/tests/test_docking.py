...
def test_generate_pose_basic_functionality(disk_datastore):
    ...
    pdb_test_file = os.path.join(ASSETS_PATH, "cleaned_3cyx.pdb")
    ligand_test_file = os.path.join(ASSETS_PATH, "ligand_3cyx.pdb")
...
def test_generate_pose_sdf_ligands(disk_datastore):
    ...
    pdb_test_file = os.path.join(ASSETS_PATH, "cleaned_3cyx.pdb")
    ligand_sdf_file = os.path.join(ASSETS_PATH, "ligand_3cyx.sdf")
