...
@patch(
    "deepchem_server.core.primitives.fep.rbfe.run_rbfe.system_setup.dry_run_edge",
    return_value=mocked_result,
)
def test_run_rbfe_dry_run(
    patched_run_edge,
    caplog,
...
def test_run_rbfe_dry_run_nested_full_address(
    patched_run_edge,
    caplog,
    protein_nested_datastore_address,
    ligands_nested_large_datastore_address,
    run_rbfe_nested_kwargs,
):
    """Tests RBFE dry run"""
...
@patch(
    "deepchem_server.core.primitives.fep.rbfe.run_rbfe.system_setup.run_edge",
    return_value=mocked_result,
)
def test_run_rbfe(
    patched_run_edge,
...
def test_run_rbfe_single_dir_output_key(
    patched_run_edge,
    caplog,
    protein_datastore_address,
    ligands_large_datastore_address,
...
def test_run_rbfe_nested_dir_output_key(
    patched_run_edge,
    caplog,
    protein_datastore_address,
    ligands_large_datastore_address,
